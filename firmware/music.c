...
void play_note2(char note, uint8_t flat, uint8_t octave, uint8_t duration) {
	...
	switch (octave) {
		case 0: switch (note) {
				case 'A': if(flat){OCR3A=Ab0;}
						  else {OCR3A=A0;}
						  break;
				case 'B': if(flat){OCR3A=Bb0;}
						  else {OCR3A=B0;}
						  break;
				case 'C': OCR3A=C0;
					  break;
				case 'D': if(flat){OCR3A=Db0;}
						  else {OCR3A=D0;}
						  break;
				case 'E': if(flat){OCR3A=Eb0;}
						  else {OCR3A=E0;}
						  break;
				case 'F': OCR3A=F0;
					  break;
				case 'G': if(flat){OCR3A=Gb0;}
						  else {OCR3A=G0;}
						  break;
			} 
			break;
		case 1: switch (note) {
				case 'A': if(flat){OCR3A=Ab1;}
						  else {OCR3A=A1;}
						  break;
				case 'B': if(flat){OCR3A=Bb1;}
						  else {OCR3A=B1;}
						  break;
				case 'C': OCR3A=C1;
					  break;
				case 'D': if(flat){OCR3A=Db1;}
						  else {OCR3A=D1;}
						  break;
				case 'E': if(flat){OCR3A=Eb1;}
						  else {OCR3A=E1;}
						  break;
				case 'F': OCR3A=F1;
					  break;
				case 'G': if(flat){OCR3A=Gb1;}
						  else {OCR3A=G1;}
						  break;
			} 
			break;
		case 2: switch (note) {
				case 'A': if(flat){OCR3A=Ab2;}
						  else {OCR3A=A2;}
						  break;
				case 'B': if(flat){OCR3A=Bb2;}
						  else {OCR3A=B2;}
						  break;
				case 'C': OCR3A=C2;
					  break;
				case 'D': if(flat){OCR3A=Db2;}
						  else {OCR3A=D2;}
						  break;
				case 'E': if(flat){OCR3A=Eb2;}
						  else {OCR3A=E2;}
						  break;
				case 'F': OCR3A=F2;
					  break;
				case 'G': if(flat){OCR3A=Gb2;}
						  else {OCR3A=G2;}
						  break;
			} 
			break;
		case 3: switch (note) {
				case 'A': if(flat){OCR3A=Ab3;}
						  else {OCR3A=A3;}
						  break;
				case 'B': if(flat){OCR3A=Bb3;}
						  else {OCR3A=B3;}
						  break;
				case 'C': OCR3A=C3;
					  break;
				case 'D': if(flat){OCR3A=Db3;}
						  else {OCR3A=D3;}
						  break;
				case 'E': if(flat){OCR3A=Eb3;}
						  else {OCR3A=E3;}
						  break;
				case 'F': OCR3A=F3;
					  break;
				case 'G': if(flat){OCR3A=Gb3;}
						  else {OCR3A=G3;}
						  break;
			} 
			break;
		case 4: switch (note) {
				case 'A': if(flat){OCR3A=Ab4;}
						  else {OCR3A=A4;}
						  break;
				case 'B': if(flat){OCR3A=Bb4;}
						  else {OCR3A=B4;}
						  break;
				case 'C': OCR3A=C4;
					  break;
				case 'D': if(flat){OCR3A=Db4;}
						  else {OCR3A=D4;}
						  break;
				case 'E': if(flat){OCR3A=Eb4;}
						  else {OCR3A=E4;}
						  break;
				case 'F': OCR3A=F4;
					  break;
				case 'G': if(flat){OCR3A=Gb4;}
						  else {OCR3A=G4;}
						  break;
			} 
			break;
		case 5: switch (note) {
				case 'A': if(flat){OCR3A=Ab5;}
						  else {OCR3A=A5;}
						  break;
				case 'B': if(flat){OCR3A=Bb5;}
						  else {OCR3A=B5;}
						  break;
				case 'C': OCR3A=C5;
					  break;
				case 'D': if(flat){OCR3A=Db5;}
						  else {OCR3A=D5;}
						  break;
				case 'E': if(flat){OCR3A=Eb5;}
						  else {OCR3A=E5;}
						  break;
				case 'F': OCR3A=F5;
					  break;
				case 'G': if(flat){OCR3A=Gb5;}
						  else {OCR3A=G5;}
						  break;
			} 
			break;
		case 6: switch (note) {
				case 'A': if(flat){OCR3A=Ab6;}
						  else {OCR3A=A6;}
						  break;
				case 'B': if(flat){OCR3A=Bb6;}
						  else {OCR3A=B6;}
						  break;
				case 'C': OCR3A=C6;
					  break;
				case 'D': if(flat){OCR3A=Db6;}
						  else {OCR3A=D6;}
						  break;
				case 'E': if(flat){OCR3A=Eb6;}
						  else {OCR3A=E6;}
						  break;
				case 'F': OCR3A=F6;
					  break;
				case 'G': if(flat){OCR3A=Gb6;}
						  else {OCR3A=G6;}
						  break;
			} 
			break;
		case 7: switch (note) {
				case 'A': if(flat){OCR3A=Ab7;}
						  else {OCR3A=A7;}
						  break;
				case 'B': if(flat){OCR3A=Bb7;}
						  else {OCR3A=B7;}
						  break;
				case 'C': OCR3A=C7;
					  break;
				case 'D': if(flat){OCR3A=Db7;}
						  else {OCR3A=D7;}
						  break;
				case 'E': if(flat){OCR3A=Eb7;}
						  else {OCR3A=E7;}
						  break;
				case 'F': OCR3A=F7;
					  break;
				case 'G': if(flat){OCR3A=Gb7;}
						  else {OCR3A=G7;}
						  break;
			} 
			break;
		case 8: switch (note) {
				case 'A': if(flat){OCR3A=Ab8;}
						  else {OCR3A=A8;}
						  break;
				case 'B': if(flat){OCR3A=Bb8;}
						  else {OCR3A=B8;}
						  break;
				case 'C': OCR3A=C8;
					  break;
				case 'D': if(flat){OCR3A=Db8;}
						  else {OCR3A=D8;}
						  break;
				case 'E': if(flat){OCR3A=Eb8;}
						  else {OCR3A=E8;}
						  break;
				case 'F': OCR3A=F8;
					  break;
				case 'G': if(flat){OCR3A=Gb8;}
						  else {OCR3A=G8;}
						  break;
			} 
			break;
		default: OCR3A=0x0000;
	}
}
...
ISR(TIMER3_COMPA_vect) {
	if(rest_flag2 == 0) 
		PORTD ^= ALARM_PIN2; 
	if(beat2 >= max_beat2) {   //if we've played the note long enough
		rest_flag2 = 0; 
